...
var LCurly = dslTokens.LCurly, RCurly = dslTokens.RCurly, LSquare = dslTokens.LSquare, RSquare = dslTokens.RSquare, Pipe = dslTokens.Pipe, Newline = dslTokens.Newline, Arrow = dslTokens.Arrow, Ellipsis = dslTokens.Ellipsis, LengthFunction = dslTokens.LengthFunction, After = dslTokens.After, OnEvent = dslTokens.OnEvent, If = dslTokens.If, Else = dslTokens.Else, When = dslTokens.When, Label = dslTokens.Label, Checkpoint = dslTokens.Checkpoint, NumberLiteral = dslTokens.NumberLiteral, /* TimeSpan, StateNodeName, Directive, Assignment, */ LineComment = dslTokens.LineComment, WhiteSpace = dslTokens.WhiteSpace;
...
var allTokens = [
    ...
    LengthFunction,
    After, OnEvent, If, Else, When, Label, Checkpoint,
    Directive, Assignment, StateNodeName,
];
