...
var DslVisitorWithDefaults = /** @class */ (function (_super) {
    ...
    DslVisitorWithDefaults.prototype.stateNode = function (ctx) {
        ...
        var name = "".concat((0, util_1.escapeDots)(nameDef.image), ":").concat(nameDef.startLine);
        ...
        var checkpointMatch = ctx.Checkpoint ? ctx.Checkpoint[0].image.match(/^§(§)?(\w+)/) : undefined;
        if (checkpointMatch) {
            checkpoint = {
                name: checkpointMatch[2],
                exitBehavior: checkpointMatch[1] ? types_1.ExitBehavior.immediate : types_1.ExitBehavior.defer
            };
        }
                ...
                if (subNodes) {
                    ...
                    if (firstSubNodeNameDef && util_1.promptStateRegExp.test(firstSubNodeNameDef.image)) {
                        ...
                        nluContext = {
                            ...
                            contextId: /^\?!\s\w+$/.test(firstSubNodeNameDef.image) ? (_a = firstSubNodeNameDef.image.match(/^\?!\s\w+$/)) === null || _a === void 0 ? void 0 : _a[0] : null,
                            regExps: regExps,
                            includes: []
                        };
